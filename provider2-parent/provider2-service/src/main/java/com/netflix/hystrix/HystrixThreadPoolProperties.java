...
public abstract class HystrixThreadPoolProperties {
    ...
    /* defaults */
    private Integer default_coreSize = 100; // size of thread pool
    ...
    private Integer default_maxQueueSize = 100; // size of queue (this can't be dynamically changed so we use 'queueSizeRejectionThreshold' to artificially limit and reject)
                                               // -1 turns if off and makes us use SynchronousQueue
    private Integer default_queueSizeRejectionThreshold = 100; // number of items in queue 
